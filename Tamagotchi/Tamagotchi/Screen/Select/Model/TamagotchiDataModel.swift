...
struct Tamagotchi {
    let tamagotchi: [TamagotchiDataModel] = [
        ...
        TamagotchiDataModel(image: "2-6", name: "방실방실 다마고치", description: "저는 방실방실다마고치 입니당 키는 100km\n몸무게는 150톤이에용\n성격은 화끈하고 날라다닙니당~!\n열심히 잘 먹고 잘 클 자신은\n있답니당 방실방실", level: 1),
        TamagotchiDataModel(image: "3-6", name: "반짝반짝 다마고치", description: "반짝반작 다마고치", level: 1),
